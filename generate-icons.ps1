...
# Vinglas-ikonen (icon_glass.png) genereras EJ här — den är kopierad från KultgubbenWine
# och matchas med huvudappens utseende. Uppskalningen sköts i view-koden via drawBitmap2
# med FILTER_MODE_BILINEAR för mjukt anti-aliasat resultat.
